...
import { api, type House, type Bid, type Estimate, type Media, type TotalCost, type Conveyancing, type Milestone, type BorrowingLimits } from "@/lib/api";
import { HOUSE_STATUSES } from "@/lib/types";
import type { ChecklistItem } from "@/lib/types";

const TABS_BASE = ["details", "bids", "checklist", "estimates", "media", "costs"] as const;
...
export default function HouseDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const tabs = [...TABS_BASE, ...(showLegal ? ["legal"] as const : []), ...(isApt ? ["apartment"] as const : [])];
